...
class Ui_menu_window(object):
    def setupUi(self, menu_window):
        ...
        self.which_user.setGeometry(QtCore.QRect(190, 30, 140, 40))
        font = QtGui.QFont()
        ...
        self.which_user.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.which_user.setText("")
        self.which_user.setObjectName("which_user")
        self.progress_label = QtWidgets.QLabel(self.groupBox)
        self.progress_label.setGeometry(QtCore.QRect(20, 100, 140, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.level_label.setGeometry(QtCore.QRect(20, 200, 101, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.level_label.setFont(font)
        self.level_label.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.level_label.setObjectName("level_label")
        self.lcdNumber = QtWidgets.QLCDNumber(self.groupBox)
        self.lcdNumber.setGeometry(QtCore.QRect(190, 200, 64, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.progress_label_5.setGeometry(QtCore.QRect(20, 280, 131, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.progress_label_5.setFont(font)
        self.progress_label_5.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.total_time_show.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.play.setGeometry(QtCore.QRect(60, 410, 100, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.quit_2.setGeometry(QtCore.QRect(240, 410, 100, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.which_user_label.setGeometry(QtCore.QRect(20, 30, 140, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.which_user_label.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.which_user_label.setObjectName("which_user_label")
        self.quit = QtWidgets.QPushButton(self.groupBox)
        self.quit.setGeometry(QtCore.QRect(420, 410, 100, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, menu_window):
        ...
        self.which_user_label.setText(_translate("menu_window", "Username:"))
