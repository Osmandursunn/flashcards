...
class login_menu(object):
    def setupUi(self, loginwindow):
        ...
        self.login_button.setGeometry(QtCore.QRect(100, 270, 200, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.login_button.setFont(font)
        self.login_button.setStyleSheet("background-color: rgba(255, 255, 255, 10);")
        self.login_button.setObjectName("login_button")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(139, 70, 122, 40))
    ...
    def retranslateUi(self, loginwindow):
        ...
        self.label_3.setText(_translate("loginwindow", "Flashcards"))
...
class main_menu(object):
    ...
    def retranslateUi(self, menu_window):
        _translate = QtCore.QCoreApplication.translate
        menu_window.setWindowTitle(_translate("menu_window", "Flashcards"))
        ...
        self.which_user_label.setText(_translate("menu_window", "Welcome   "))
...
"background-color: rgb(255, 0, 0);")
        ...
        self.label_3.setGeometry(QtCore.QRect(540, 30, 111, 40))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.known_word_lcd.setGeometry(QtCore.QRect(710, 30, 60, 40))
        ...
        self.time_lcd_word.setGeometry(QtCore.QRect(60, 30, 151, 81))
